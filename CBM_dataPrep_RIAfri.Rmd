...
df_params <- SpaDES.core::moduleParams("CBM_dataPrep_RIAfri", "..")
...
df_inputs <- SpaDES.core::moduleInputs("CBM_dataPrep_RIAfri", "..")
...
df_outputs <- SpaDES.core::moduleOutputs("CBM_dataPrep_RIAfri", "..")
