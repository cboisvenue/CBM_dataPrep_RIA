defineModule(sim, list(
  ...
  outputObjects = bindrows(
    ...
    createsOutput(
      ...
      desc = "Ages of the stands from the inventory in 2020, modified so ages <=1 are set to 2 for C++ Spinup() fnct."
    ),
    createsOutput(
...
#   ## End rasters------------------------------------------------------------------
  ...
  #sim$gcids <- sim$level3DT$gcids ## TOOLS to debug Spinup()
